...
function [channel_estimation] = equalize_interpolate_pilot(obj, pilot_ch)

    % at which point will we interpolate
    Y = obj.d_k_m_pilot_indices.pos_f;
    X = obj.d_k_m_pilot_indices.pos_t;
    V = pilot_ch;
